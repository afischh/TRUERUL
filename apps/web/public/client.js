(function () {
  ...
  const completionTemplates = [
    ...
    '(мир world-b)',
    '(миры)',
    '(мир-показать world-a)',
    '(мир-активировать world-a)',
    '(сравнить-миры world-a world-b)',
    '(объединить-миры world-a world-b :в world-merge)',
    '(вычесть-мир world-a world-b :в world-diff)',
    ...
    '(классы-вывода)',
    '(режим :язык ru :логика classical :онтология mixed :оценка semi-strict)',
    '(история)',
    '(назад)',
    '(повторить)',
    '(помощь)'
